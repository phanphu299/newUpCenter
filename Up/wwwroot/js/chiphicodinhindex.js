var vue = new Vue({
    el: '#ChiPhiCoDinhIndex',
    data: {
        title: 'Quản Lý Chi Phí Cố Định',
        messageText: '',
        color: '',
        timeout: 3000,
        snackbar: false,
    ...
    async beforeCreate() {
        let that = this;
        await axios.get('/category/GetStaticExpenseAsync')
    ...
    methods: {
        ...
        async onSave(item) {
            if (this.newItem.name === '') {
                ...
                await axios({
                    method: 'post',
                    url: '/category/CreateStaticExpenseAsync',
                    data: {
        ...
        async onDelete(item) {
            ...
            await axios({
                method: 'delete',
                url: '/category/DeleteStaticExpenseAsync',
                data: {
                    ChiPhiCoDinhId: item.chiPhiCoDinhId
                }
            })
