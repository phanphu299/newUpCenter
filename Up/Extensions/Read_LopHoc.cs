namespace Up.Extensions
{
    ...
    public class Read_LopHoc : BasePolicy, IActionFilter
    {
        ...
        {
            bool canAccess = CanAccessAsync(context.HttpContext.User, (int)QuyenEnums.Read_LopHoc, (int)QuyenEnums.Contribute_LopHoc).Result;
